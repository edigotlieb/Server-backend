...
public abstract class AppRequest extends Request{
    ...
    public enum APP_ACTION_TYPE {
        ...
        CREATE_APP,GET_TABLE_INFO,GET_TABLES,SET_PERMISSIONGROUP_ADMIN,ADD_PERMISSION_GROUP_FOR_TABLE,REMOVE_PERMISSION_GROUP_FOR_TABLE, GET_ALL_APPS,GET_ALL_PERMISSIONS;
    }
